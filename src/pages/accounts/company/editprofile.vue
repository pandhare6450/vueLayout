...
<script setup>
import Header from '@pages/accounts/company/parts/editHead.vue'
import Edit from '@pages/accounts/company/parts/editFields.vue'
import Password from '@pages/accounts/company/parts/password.vue'
import Timezone from '@pages/accounts/company/parts/Timezone.vue'
